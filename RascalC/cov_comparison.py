...
def rms_eig_inv_test_covs(C1: npt.NDArray[np.float64], C2: npt.NDArray[np.float64]) -> float:
...
def KL_div_covs(C1: npt.NDArray[np.float64], C2: npt.NDArray[np.float64]) -> float:
...
def chi2_red_covs(C1: npt.NDArray[np.float64], C2: npt.NDArray[np.float64]) -> float:
