...
def write_binning_file(out_file: str, r_edges: np.typing.NDArray[np.float64], print_function: Callable[[str], None] = blank_function):
...
def write_binning_file_linear(out_file: str, r_min: float, r_max: float, nrbins: int, print_function: Callable[[str], None] = print):
...
def write_binning_file_log(out_file: str, r_min: float, r_max: float, nrbins: int, print_function: Callable[[str], None] = print):
...
def write_binning_file_hybrid(out_file: str, r_min: float, r_cut: float, r_max: float, n_log_bins: int, n_lin_bins: int, print_function: Callable[[str], None] = print):
