...
def convert_counts_from_pycorr_to_file(xi_estimator: pycorr.twopoint_estimator.BaseTwoPointEstimator, outfile_name: str, n_mu: int | None = None, r_step: float = 1, r_max: float = np.inf, counts_factor: float | None = None, split_above: float = np.inf) -> None:
...
def convert_counts_from_pycorr_files(infile_name: str, outfile_name: str, n_mu: int | None = None, r_step: float = 1, r_max: float = np.inf, counts_factor: float | None = None, split_above: float = np.inf) -> None:
