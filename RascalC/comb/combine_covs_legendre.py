...
def combine_covs_legendre(rascalc_results1: str | Path, rascalc_results2: str | Path, allcounts_file1: str | Path, allcounts_file2: str | Path, output_cov_file: str | Path, max_l: int, r_step: float = 1, skip_r_bins: int | tuple[int, int] = 0, output_cov_file1: str | Path | None = None, output_cov_file2: str | Path | None = None, allcounts_format: Literal[None, "pycorr", "lsstypes"] = None, print_function: Callable[[str], None] = print) -> npt.NDArray[np.float64]:
    """
    ...
    allcounts_file1, allcounts_file2 : list of strings or Path objects
        ...
        If you use a non-standard extension, you can specify the format with the ``allcounts_format`` argument.
    ...
    allcounts_format = validate_allcounts_format(allcounts_format, [allcounts_file1, allcounts_file2])
