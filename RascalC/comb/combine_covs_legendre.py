...
def combine_covs_legendre(rascalc_results1: str, rascalc_results2: str, allcounts_file1: str, allcounts_file2: str, output_cov_file: str, max_l: int, r_step: float = 1, skip_r_bins: int | tuple[int, int] = 0, output_cov_file1: str | None = None, output_cov_file2: str | None = None, allcounts_format: Literal[None, "pycorr", "lsstypes"] = None, print_function: Callable[[str], None] = print) -> npt.NDArray[np.float64]:
    """
    ...
    allcounts_file1, allcounts_file2 : list of strings
