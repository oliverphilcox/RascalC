...
def post_process_default_multi(file_root: str, n: int, m: int, outdir: str, alpha_1: float = 1, alpha_2: float = 1, skip_r_bins: int = 0, n_samples: None | int | list[int] | np.ndarray[int] = None, print_function = print) -> dict[str]:
