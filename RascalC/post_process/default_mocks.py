...
def post_process_default_mocks(mock_cov_file: str, file_root: str, n: int, m: int, outdir: str, skip_r_bins: int | tuple[int, int] = 0, tracer: int = 0, n_samples: None | int | Iterable[int] | Iterable[bool] = None, print_function = print) -> dict[str]:
