...
def compute_D_precision_matrix(partial_cov: npt.NDArray[np.float64], full_cov: npt.NDArray[np.float64]) -> tuple[npt.NDArray[np.float64], npt.NDArray[np.float64]]:
...
def compute_N_eff_D(full_D_est: npt.NDArray[np.float64], print_function = blank_function) -> float:
...
def load_matrices_multi(input_data: dict[str], cov_filter: npt.NDArray[np.int_], full: bool = True, jack: bool = False, ntracers: int = 2) -> tuple[npt.NDArray[np.float64], npt.NDArray[np.float64], npt.NDArray[np.float64]]:
...
def add_cov_terms_multi(c2: npt.NDArray[np.float64], c3: npt.NDArray[np.float64], c4: npt.NDArray[np.float64], alphas: list[float] | npt.NDArray[np.float64], ntracers: int = 2) -> tuple[npt.NDArray[np.float64], npt.NDArray[np.float64]]:
