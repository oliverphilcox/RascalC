## Script to correct correction function norm in runs of older versions of RascalC in Legendre mode
## Determines single-field vs multi-field automatically (no jackknife), but by default does no changes for 2nd field
...
for ii in range(len(I1)): # loop over all field combinations
    ...
    # rescale
    c2 *= (norm[I1[ii]] * norm[I2[ii]])**2
    c3 *= norm[I2[ii]]**2 * norm[I1[ii]] * norm[I3[ii]]
    c4 *= norm[I1[ii]] * norm[I2[ii]] * norm[I3[ii]] * norm[I4[ii]]
    # write
    for i in range(n_samples):
