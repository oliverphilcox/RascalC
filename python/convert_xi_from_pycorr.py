...
def convert_xi_from_pycorr_to_file(xi_estimators: list[pycorr.twopoint_estimator.BaseTwoPointEstimator], outfile_name: str, n_mu: int | None = None, r_step: float = 1, r_max: float = np.inf, print_function = print) -> (float, float):
