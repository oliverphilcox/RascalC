...
import numpy as np
import sys, os
from utils import cov_filter_smu, load_full_matrices, load_subsample_matrices, check_eigval_convergence, add_cov_terms, check_positive_definiteness, compute_D_precision_matrix, compute_N_eff_D
...
def post_process_default(file_root: str, n: int, m: int, outdir: str, alpha: float = 1, skip_r_bins: int = 0, tracer: int = 1, print_function = print) -> dict[str]:
    ...
    c2, c3, c4 = load_full_matrices(input_file, cov_filter, tracer, jack = False, legendre = False)
