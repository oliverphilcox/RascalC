...
public:
	...
	char *fname = NULL;
	const char default_fname[500] = "/mnt/store1/oliverphilcox/GRFs_aper_dense_big/tot_ran";//PowerSpectra/qpm_randoms_10x.xyzwj";//randoms_10x.xyzwj"; 
    
    // Name of the radial binning .csv file
    char *radial_bin_file = NULL;
    const char default_radial_bin_file[500] = "/mnt/store1/oliverphilcox/GRFs_aper_dense_big/binning_file_15.csv";//3PCF/SE_binning_n15.csv";//PowerSpectra/k_binning2.csv";//k_binning2.csv";
    
    // The name of the correlation function file for the first set of particles
	char *corname = NULL;
	const char default_corname[500] = "/mnt/store1/oliverphilcox/GRFs_aper_dense_big/lin_xi.xi";//QPM_xi/linear_kaiser_xi.xi";//QPM_xi/QPM_mean.xi"; //3PCF_SE/xi_test.xi";//
    ...
    Float nofznorm = 300000;//642051
    
    // Output directory 
    char *out_file = NULL;
    const char default_out_file[500] = "/mnt/store1/oliverphilcox/GRFs_aper_dense_big/";//3PCF_QPM_periodic/";
    ...
    const char default_phi_file[500] = "/mnt/store1/oliverphilcox/GRFs_aper_dense_big/phi_inv";//3PCF/CorrectedBinCorrectionFactor_n15_11.txt";
