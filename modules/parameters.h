...
public:
	...
	char *fname = NULL;
	const char default_fname[500] = "/mnt/store1/oliverphilcox/Mock1QPM/randoms_x10.xyzwj"; 
    
    // Name of the radial binning .csv file
    char *radial_bin_file = NULL;
    const char default_radial_bin_file[500] = "/mnt/store1/oliverphilcox/Mock1QPM/hybrid_binfile_cut.csv";
    ...
    const char default_jk_weight_file[500] = "/mnt/store1/oliverphilcox/Mock1QPM/weights/jackknife_weights_n39_m24_j169_11.dat";
    
     // Name of the RR bin file
    char *RR_bin_file = NULL; // RR_{aA}^{11} file
    const char default_RR_bin_file[500] = "/mnt/store1/oliverphilcox/Mock1QPM/weights/binned_pair_counts_n39_m24_j169_11.dat";
