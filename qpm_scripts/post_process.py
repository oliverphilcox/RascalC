...
for mock_no in range(min_mock,max_mock+1):
    ...
    print("Saving output")
    if xi_refine:
        outfile="/mnt/store1/oliverphilcox/DR12_QPM/post_processed_xicorr/mock_%d.npz"%mock_no
    else:
        outfile="/mnt/store1/oliverphilcox/DR12_QPM/post_processed/mock_%d.npz"%mock_no
    if xi_fine:
        outfile="/mnt/store1/oliverphilcox/DR12_QPM/post_processed_xifinecorr/mock_%d.npz"%mock_no
    np.savez(outfile,             
