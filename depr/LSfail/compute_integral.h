 // This class computes the contributions to the C_ab integral iterating over cells and particles. It is a heavily modified version of code by Alex Wiegand.
    ...
    public:    
        ...
        compute_integral(Grid all_grid[], Parameters *par, JK_weights all_JK[], CorrelationFunction all_cf[], RandomDraws all_rd[], int I1, int I2, int I3, int I4, int iter_no){
            ...
            CorrelationFunction *cf23 = which_cf(all_cf,I2,I3);
    ...
    //-----------INITIALIZE OPENMP + CLASSES----------
            ...
            Integrals sumint(par, cf12, cf13, cf23, cf24, JK12, JK23, JK34, I1, I2, I3, I4,product_weights12_12,product_weights12_23,product_weights12_34); // total integral
    ...
    //-----------DEFINE LOCAL THREAD VARIABLES
            ...
            Float *xi_ik, *xi_ij, *w_ijk, *w_ij; // arrays to store xi and weight values
            ...
            Integrals locint(par, cf12, cf13, cf23, cf24, JK12, JK23, JK34, I1, I2, I3, I4, product_weights12_12, product_weights12_23, product_weights12_34); // Accumulates the integral contribution of each thread
            ...
            for (int n_loops = 0; n_loops<par->max_loops; n_loops++){
                ...
                for (int n1=0; n1<grid1->nf;n1++){
                    ...
                    for (int n2=0; n2<par->N2; n2++){
                        ...
                        // Compute C2 integral
                        locint.second(prim_list, prim_ids, pln, particle_j, pid_j, bin_ij, xi_ij, w_ij, p2, p21, p22);
                        ...
                        for (int n3=0; n3<par->N3; n3++){
                            ...
                            locint.third(prim_list, prim_ids, pln, particle_j, particle_k, pid_j, pid_k, bin_ij, w_ij, xi_ik, xi_ij, w_ijk, p3);
