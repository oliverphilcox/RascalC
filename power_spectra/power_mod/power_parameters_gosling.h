...
public:
    ...
    const char default_radial_bin_file[500] = "/mnt/alan1/oliverphilcox/PowerSpectra/k_binning2.csv";
    ...
    const char default_phi_file[500] = "/mnt/alan1/oliverphilcox/PowerSpectra/InvPhiCoeff_DR12.txt";
