...
project = 'RascalC'
copyright = '2019-2026, Oliver Philcox, Ross O\'Connell, Daniel Eisenstein, Alex Wiegand, Misha Rashkovetskyi'
...
man_pages = [
    (master_doc, 'rascalc', 'RascalC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RascalC', 'RascalC Documentation',
     author, 'RascalC', 'One line description of project.',
     'Miscellaneous'),
]
