...
The main estimators are described in O'Connell et al. 2016 (`arXiv <https://arxiv.org/abs/1510.01740>`_), O'Connell & Eisensein 2018 (`arXiv <https://arxiv.org/abs/1808.05978>`_) and Philcox et al. 2019 (in prep.), with the final paper discussing this implementation in C++.
