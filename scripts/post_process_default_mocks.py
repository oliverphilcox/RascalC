...
parser = argparse.ArgumentParser(description="Script to post-process the single-field integrals computed by the C++ code (in radial and angular/mu bins), optimizing the shot-noise rescaling parameter to the mock-derived covariance matrix.")
...
post_process_default_mocks(args.mock_cov_file, args.covariance_dir, args.n_r_bins, args.n_mu_bins, args.output_dir, args.skip_r_bins)
